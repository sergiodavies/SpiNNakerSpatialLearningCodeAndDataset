...
output_metrics_filename = "output_metrics_1.csv"
output_metrics_file = open(output_metrics_filename, 'w')

# Print column heading in the CSV file
output_string = 'Code Word 0, Homeostasis factor, Positives, Negatives, True Positives, True Negatives, False Positives, False Negatives, Accuracy, Precision, Negative Prediction, Sensitivity, Specificity\n'
